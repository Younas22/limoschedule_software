<x-admin.layouts.guest :title="'Reset Password'">
    <h1 class="mb-1 text-xl font-semibold text-luxury-white">Reset your password</h1>
    <p class="mb-6 text-sm text-luxury-muted">Choose a new password for your account.</p>
