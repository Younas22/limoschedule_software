<x-admin.layouts.app :title="'Edit Post'">
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-2xl font-semibold text-luxury-white">Edit Post</h2>
    ...
    <form method="POST" action="{{ route('admin.blog.update', $post) }}" enctype="multipart/form-data">
        ...
        <div class="mt-6 flex items-center justify-end gap-3">
            ...
            <x-admin.button type="submit" variant="primary">Update Post</x-admin.button>
        </div>
    </form>
</x-admin.layouts.app>
