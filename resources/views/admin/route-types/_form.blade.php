...
<div class="space-y-5 rounded-2xl border border-luxury-border bg-luxury-charcoal p-6">
    <div>
        <x-admin.input-label for="name" value="Route Type Name" />
        <x-admin.text-input id="name" name="name" type="text" value="{{ old('name', $routeType?->name) }}" placeholder="e.g. Airport Route" required autofocus />
