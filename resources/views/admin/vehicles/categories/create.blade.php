<x-admin.layouts.app :title="'Add Fleet Category'">
    <div class="mb-6">
        <h2 class="text-2xl font-semibold text-luxury-white">Add Fleet Category</h2>
        <p class="mt-1 text-sm text-luxury-muted">Create a new vehicle category.</p>
    </div>
