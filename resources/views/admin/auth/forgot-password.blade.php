<x-admin.layouts.guest :title="'Forgot Password'">
    <h1 class="mb-1 text-xl font-semibold text-luxury-white">Forgot your password?</h1>
    <p class="mb-6 text-sm text-luxury-muted">Enter your email and we'll send you a reset link.</p>
