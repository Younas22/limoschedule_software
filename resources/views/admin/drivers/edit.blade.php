<x-admin.layouts.app :title="'Edit Driver'">
    <div class="mb-6">
        <h2 class="text-2xl font-semibold text-luxury-white">Edit Driver</h2>
        <p class="mt-1 text-sm text-luxury-muted">Update the details for {{ $driver->name }}.</p>
    </div>
    ...
    <div class="mt-6 overflow-hidden rounded-2xl border border-luxury-border bg-luxury-charcoal">
        <div class="flex items-center justify-between border-b border-luxury-border px-6 py-4">
            <h3 class="text-sm font-semibold text-luxury-white">Driver Reviews</h3>
