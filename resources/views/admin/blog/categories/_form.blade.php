...
<div class="space-y-5 rounded-2xl border border-luxury-border bg-luxury-charcoal p-6">
    <div>
        ...
        <x-admin.text-input id="name" name="name" type="text" value="{{ old('name', $category?->name) }}" placeholder="e.g. Travel Tips" required autofocus />
    ...
    <div x-data="{ preview: '{{ $category?->image_url }}' }">
        ...
        <p class="mt-2 text-xs text-luxury-muted">Category cover image. Max 2MB.</p>
