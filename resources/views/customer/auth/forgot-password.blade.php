<x-customer.layouts.guest :title="__('Forgot Password')">
    ...
    <form method="POST" action="{{ route('customer.password.email') }}" class="space-y-5">
        ...
        <a href="{{ route('customer.login') }}" class="block text-center text-sm text-luxury-muted hover:text-luxury-white">
            {{ __('Back to sign in') }}
        </a>
    </form>
