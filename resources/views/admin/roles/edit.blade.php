<x-admin.layouts.app :title="'Edit Role'">
    <div class="mb-6">
        <h2 class="text-2xl font-semibold text-luxury-white">Edit Role</h2>
        <p class="mt-1 text-sm text-luxury-muted">Update the role details and its module permissions.</p>
    </div>
