<x-admin.layouts.app :title="'Revenue Report'">
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-2xl font-semibold text-luxury-white">Revenue Report</h2>
            <p class="mt-1 text-sm text-luxury-muted">Paid bookings within the selected date range.</p>
        </div>
    ...
    <div class="mb-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <x-admin.stat-card label="Total Revenue" :value="currency($summary['total_revenue'])">
        ...
        <x-admin.stat-card label="Paid Bookings" :value="number_format($summary['paid_count'])" :trend="'Avg fare '.currency($summary['average_fare'])">
        ...
        <x-admin.stat-card label="Pending Payment" :value="number_format($summary['pending_count'])">
        ...
        <x-admin.stat-card label="Refunded" :value="number_format($summary['refunded_count'])" :trend="currency($summary['refunded_amount']).' refunded'">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-start text-sm">
                ...
                <tbody class="divide-y divide-luxury-border/60">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-10 text-center text-luxury-muted">No paid bookings in this range.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
