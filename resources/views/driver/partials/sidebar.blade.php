@php
    $navItems = [
        ...
        ['label' => __('My Bookings'), 'route' => 'driver.bookings.index', 'icon' => 'car'],
        ['label' => __('Earnings'), 'route' => 'driver.earnings.index', 'icon' => 'cash'],
        ['label' => __('Reviews'), 'route' => 'driver.reviews.index', 'icon' => 'star'],
        ['label' => __('Profile Settings'), 'route' => 'driver.profile.edit', 'icon' => 'user'],
        ['label' => __('Preferences'), 'route' => 'driver.settings.edit', 'icon' => 'settings'],
        ['label' => __('Security'), 'route' => 'driver.security.edit', 'icon' => 'lock'],
    ];
@endphp
